  ...
  if (!session) {
    return (
      <div className={`min-h-screen w-full flex flex-col items-center justify-center ${themeColors.bg} text-white p-6 relative overflow-hidden`}>
        ...
        <div className="z-10 w-full max-w-md space-y-8 animate-in zoom-in-95 duration-700">
          <div className="text-center space-y-4">
            <div className="inline-flex items-center justify-center w-24 h-24 bg-rose-500/10 rounded-3xl border border-rose-500/20 shadow-2xl mb-4 animate-float">
